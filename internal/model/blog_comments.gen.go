...
type BlogComments struct {
	...
	BlogID     uint64     `gorm:"column:blog_id;type:bigint(20) unsigned;not null;comment:探店id" json:"blogId"`                                 // 探店id
	ParentID   uint64     `gorm:"column:parent_id;type:bigint(20) unsigned;not null;comment:关联的1级评论id，如果是一级评论，则值为0" json:"parentId"`           // 关联的1级评论id，如果是一级评论，则值为0
	AnswerID   uint64     `gorm:"column:answer_id;type:bigint(20) unsigned;not null;comment:回复的评论id" json:"answerId"`                          // 回复的评论id
