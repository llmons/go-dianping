...
type SeckillVoucher struct {
	VoucherID  uint64     `gorm:"column:voucher_id;type:bigint(20) unsigned;primaryKey;comment:关联的优惠券的id" json:"voucherId"`                    // 关联的优惠券的id
	...
	BeginTime  *time.Time `gorm:"column:begin_time;type:timestamp;not null;default:current_timestamp();comment:生效时间" json:"beginTime"`         // 生效时间
	EndTime    *time.Time `gorm:"column:end_time;type:timestamp;not null;default:current_timestamp();comment:失效时间" json:"endTime"`             // 失效时间
